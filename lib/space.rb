...
class Space
  ...
  def self.create(name:, description:, pricexnight:, location:, id_categories:, id_user:)
    ...
    Space.new(id: result[0]['id'], name: result[0]['name'], pricexnight: result[0]['pricexnight'], location: result[0]['location'], id_categories: result[0]['id_categories'], id_user: result[0]['id_user'])
  end
